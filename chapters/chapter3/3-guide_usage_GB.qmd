...
Voici une procédure simple reposant sur une validation croisée. Elle est assez coûteuse sur le plan computationnel et donc adaptée à des données peu volumineuses.
...
#### Approche 2: procédure itérative par validation simple
