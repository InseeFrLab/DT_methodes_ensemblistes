...
- __Optimiser conjointement le nombre d'arbres et le taux d'apprentissage__. Attention c'est long. Gridsearch avec ou sans CV, avec _early stopping_, avec des valeurs raisonnables pour les principaux HP. Nombre d'arbres: variable, _learning rate_: [0.05, 0.1, 0.15, 0.2]. Recommencer si le nombre d'arbres n'était pas suffisant. Une fois défini le bon nombre d'arbres, mettre 20% de plus.
