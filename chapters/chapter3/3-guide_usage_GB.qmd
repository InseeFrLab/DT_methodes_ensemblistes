...
- __Utiliser l'_early stopping_ avec l'ensemble de validation__. Dans le cas de l'approche _holdout_, il est possible d

### Optimiser les hyperparamètres

#### Une première procédure simple: validation croisée
...
#### Une seconde procédure simple: validation simple
