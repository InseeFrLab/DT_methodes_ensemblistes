...
Une différence notable entre les versions initiales de `LightGBM` et `XGBoost` tient à la méthode de construction des arbres (figure @fig-leaf-wise):
...
![Les approches _depth-wise_ et _leaf-wise_](/figures/leafwise-depthwise.png){#fig-leaf-wise width=60%}
:::
