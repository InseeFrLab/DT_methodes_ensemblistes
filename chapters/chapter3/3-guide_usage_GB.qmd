...
__Contrairement aux forêts aléatoires, les valeurs par défaut des hyperparamètres des implémentations ne constituent pas un point de départ raisonnable__ (@bentejac2021comparative), en particulier pour les hyperparamètres de régularisation dont la valeur par défaut est nulle.
