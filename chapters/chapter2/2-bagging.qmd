...
Pour mieux comprendre comment l'agrégation améliore la performance globale d'un modèle individuel $\phi(x, L)$, revenons à la **décomposition biais-variance** de l'erreur quadratique moyenne, qui est une mesure de performance très courante pour les problèmes de régression:
...
L'erreur quadratique moyenne se décompose en deux termes:
