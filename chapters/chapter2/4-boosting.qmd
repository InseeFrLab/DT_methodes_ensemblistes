...
2. Pour **chaque** noeud de l'arbre, on essaie de trouver un partitionnement optimal:
    ...
    - Si la meilleure règle de décision apporte un gain suffisamment élevé, on crée deux nouveaux noeuds.
