...
On souhaite construire le $t$-ième arbre qui minimise la perte, conditionnellement aux données et aux $t-1$ arbres déjà construits. Formellement on cherche un arbre $f_t$ tel que
