...
Une fois la mesure d'impureté définie, l'algorithme CART construit séquentiellement le partitionnement de l'espace des caractéristiques en comparant les règles de décision possibles. À chaque étape de la construction de l'arbre, l'algorithme construit des règles de décision candidates en parcourant toutes les valeurs de toutes les caractéristiques, calcule la réduction de l'impureté induite par chacune d'entre elles et sélectionne celle qui entraîne la réduction maximale. 
