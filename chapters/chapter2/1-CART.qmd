...
- __Dans un arbre de décision, les valeurs prises par les variables numériques (par exemple l'âge) n'ont pas d'importance par elles-mêmes, c'est l'_ordre_ de ces valeurs qui est essentiel__. Ainsi, dans la règle de décision "L'âge est-il supérieur à 30 ans?", ce n'est pas la valeur “30” qui importe par elle-même, c’est le fait qu'elle **sépare les observations** en deux groupes, selon que l'âge est inférieur ou supérieur à 30 ans. Cette propriété a pour conséquence que les arbres de décision sont insensibles aux modifications strictement monotones des variables continues. Par exemple, remplacer l'âge par l'âge au carré ne changera rien à l'arbre de décision, car les règles de décision "L'âge est-il supérieur à 30 ans?" et "L'âge au carré est-il supérieur à 900?" sont strictement équivalentes (car elles définissent les mêmes groupes).
